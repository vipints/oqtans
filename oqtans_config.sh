...
export LD_LIBRARY_PATH=$OQTANS_DEP_PATH/lib:$OQTANS_DEP_PATH/lib64:i$OQTANS_DEP_PATH/octave/lib/octave/${OQTANS_OCTAVE_VERSION}:$LD_LIBRARY_PATH

#
# Shared compiled program PATH 
# 
export PATH=$OQTANS_DEP_PATH/bin:$OQTANS_DEP_PATH/octave/bin:$OQTANS_PATH/Bowtie/1.0.0/:$OQTANS_PATH/Bowtie/2.1.0/:$OQTANS_PATH/BWA/0.6.2/:$OQTANS_PATH/PALMapper/0.5/:$OQTANS_PATH/Cufflinks/2.1.1/:$OQTANS_PATH/TopHat/1.4.1/:$OQTANS_PATH/TopHat/2.0.9/$PATH
